...
<div class="admin-wrapper manage-user user-edit">
    <div class="user-form">
        ...
        <div class="form">
            <form id="new_user" name="new_user" method="post" action="<?php echo $_core->getUrl('save-user.php')?>" onsubmit="return validate();" enctype="multipart/form-data" >
                <div class="field-group g1">
                    ...
                    <div class="fields-collection">
                        ...
                        <div class="field-row even">
                            ...
                            <select name="user_gender" class="drop-down required" id="user_gender">
                        ...
                        <img class="profile-photo left" src="<?php echo $_user->getSkinUrl($_user->getUserProfileThumbnailImage())?>" alt="Profile photo" />
                        <div class="field-row odd">
                ...
                <div class="field-group g2">
                    ...
                    <div class="field-collection">
                        ...
                        <div class="field-row even">
                            ...
                            <select class="drop-down country required" onchange="print_state('state',this.selectedIndex);" id="country" name ="user_country"></select>
                        </div>
                        <div class="field-row odd">
                            <div class="label"><label for="user_state">State<span class="require-field">*</span></label></div>
                            <select class="drop-down required" name="user_state" id="state"></select>
